...
swal({
  title: "Error!",
  text: "Max file should be less than 5MB!",
  icon: "warning",
  button: "Ok",
});
...
echo "<script>alert('Product is Added Successfully')</script>"; // Javascript Ok

echo "<script>window.open('productlist.php','_self')</script>"; // Javascript Redirect or Reload     
